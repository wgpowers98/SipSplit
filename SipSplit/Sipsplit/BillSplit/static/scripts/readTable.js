...
amountPerGuest.innerHTML = `Payment per friend $${localStorage.getItem('amountPerGuest')}`;
totalAmount.innerHTML = `Amount $${localStorage.getItem('billTotal')}`;
...
function renderTable(dataTable,numberOfGuests) 
{
    ...
    sumItems(dataTable,numberOfGuests);
